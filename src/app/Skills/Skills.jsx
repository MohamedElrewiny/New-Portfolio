      ...
      >
        {skills.map((skill) => (
          <motion.div
            ...
            className="flex flex-col items-center h-[170px] p-6 rounded-2xl relative bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700"
          >
            <div className="text-5xl h-[50px] mb-4 text-primary transform hover:scale-110 transition-transform duration-300">
              {skill.icon}
            </div>
            <h3 className="font-semibold text-center text-lg mb-4 text-gray-800 dark:text-gray-200">
              {skill.name}
            </h3>
            <div className="w-full relative">
              ...
              <div className="absolute -top-6 right-0  bg-white dark:bg-gray-800  rounded-lg shadow-md">
